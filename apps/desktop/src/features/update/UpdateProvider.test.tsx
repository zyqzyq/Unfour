...
const meta: UpdateMeta = {
  name: "Unfour", version: "0.9.3", distribution: "standard", channel: "stable",
...
beforeEach(() => {
  ...
  mocks.check.mockResolvedValue({ version: "0.9.4", currentVersion: "0.9.3", date: null, body: null });
});
...
it("installs the latest committed update once and clears pending progress timers", async () => {
  ...
  expect(result.current.state).toMatchObject({ kind: "downloading", downloaded: 30, info: { version: "0.9.4" } });
