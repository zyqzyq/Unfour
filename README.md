...
> [!WARNING]
> The source tree is preparing the Community Stable `v0.6.0` release. It is
...
The latest stable release is [`v0.5.0`](https://github.com/zyqzyq/Unfour/releases/tag/v0.5.0);
`v0.6.0` will appear there after the release is published.
...
The source tree is preparing Community Stable `v0.6.0`; the latest published
stable version is `v0.5.0`. Release readiness is documented in:
