CREATE TABLE pro_sync_outbox_api_v2 (
  ...
  CHECK (
    ...
    OR status = 'dead'
    OR (
      entity_type IN ('apiCollection', 'apiFolder', 'apiRequest')
...
INSERT INTO pro_sync_outbox_api_v2 (
...
CREATE TABLE pro_sync_entity_state_api_v2 (
  account_id TEXT NOT NULL,
  cloud_workspace_id TEXT NOT NULL,
  entity_type TEXT NOT NULL CHECK (entity_type IN (
    'workspace', 'workspaceVariable', 'workspaceEnvironment',
...
INSERT INTO pro_sync_entity_state_api_v2 (
...
ALTER TABLE pro_sync_outbox_api_v2 RENAME TO pro_sync_outbox;
ALTER TABLE pro_sync_entity_state_api_v2 RENAME TO pro_sync_entity_state;
